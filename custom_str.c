...
/**
 * custom_hex - this helps to print an hexadecimal value
 * that value is for custom characters
...
/**
 * custom_str - this prints a custom character
 *This custom character will be printed to the console
 *@args: arguments
